  ...
  <div v-else class="lg:flex block fixed w-full overflow-hidden items-center justify-between">
    <div
      ...
      <div class="w-10 block absolute top-5 left-5 lg:hidden h-10">
        <img className="w-full h-10" src="@/assets/icons/logo-devlinks-small.svg" alt="devlink logo" width="100"
      ...
      <div class="flex flex-col mt-16 items-center lg:justify-center lg:h-full">
        ...
        <div class="h-60 md:w-[30rem] mt-6 mx-auto md:h-96">
          <img className="w-full  h-60 md:h-96" src="../../public/assets/social-media-collection.svg" alt="devlink logo"
            loading="eager" />
        </div>
      </div>
      <div class="flex mt-12 flex-col lg:hidden items-center justify-center">
        ...
        <button @click="login"
          ...
          <div class="w-10 h-10">
            <img src="@/assets/icons/google_icon.webp" alt="devlink logo" loading="eager" width="40" height="40" />
          </div>
          Sign in with Google
        </button>
      </div>
    ...
    <div class="w-1/2 mx-auto hidden lg:block h-screen">
      <div class="w-36 h-8 absolute top-8 right-10">
        <img className="w-full h-8" src="../../public/assets/logo-devlinks-large.svg" alt="devlink logo"
          loading="eager" />
      </div>
      <div class="flex relative flex-col items-center h-full justify-center">
        ...
        <button @click="login"
          ...
          <div class="w-10 h-10">
            <img src="@/assets/icons/google_icon.webp" alt="devlink logo" width="40" loading="eager" height="40" />
          </div>
          Sign in with Google
        </button>
      </div>
